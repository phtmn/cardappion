        ...
        <div class="header-body">
            <div class="row align-items-center py-4">
                <div class="col-lg-6 col-7">
                    ...
                    <h1 class="display-4 text-white d-inline-block mb-0">  <i class="ni ni-settings-gear-65 text-white"></i> Configurações</h1>
                </div>
                            ...
                            <!-- <div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    <input type="text" name="docnumber" class="form-control"
                                        value="{{$config->docnumber}}" id="docnumber" placeholder="CFP ou CNPJ">
                                </div>
                            </div> -->
                            <div class="form-group row">
                                <label for="example-search-input"
