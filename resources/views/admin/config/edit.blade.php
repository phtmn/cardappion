          ...
          <div class="card-body">
            <form action="{{route('config.update')}}" method="POST" enctype="multipart/form-data">
              ...
              <div class="form-group row">
                ...
                <div class="col-md-6">
                  <input type="file" name="image" id="input-file-now" class="form-control" value="{{$config->image}}" data-default-file="{{ url("{$config->image}") }}"    />
                </div>
              </div>
              <div class="form-group row">
              ...
              <div class="form-group row">
                ...
                <div class="col-md-3">
                  <input type="text" name="telegram" class="form-control" value="{{$config->telegram}}" placeholder="https://t.me/">
                </div>
              </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-md-6">
                  <input type="text" name="instagram" class="form-control" value="{{$config->instagram}}" placeholder="https://www.instagram.com/">
                </div>
              </div>
              <div class="form-group row">
              ...
              <div class="form-group row">
                ...
                <div class="col-md-6">
                  <input type="text" name="site" class="form-control" value="{{$config->site}}" placeholder="http://">
                </div>
              </div>
