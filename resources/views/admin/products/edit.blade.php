    ...
    <div class="header-body">
      <div class="row align-items-center py-4">
        <div class="col-lg-6 col-7">
          ...
          <h1 class="display-4 text-white d-inline-block mb-0"> Produtos - Editar</h1>
        </div>
        <div class="col-lg-6 col-5 text-right">
          <a class="text-white" href="{{route('products.index')}} "><i class="ni ni-bold-left text-white"></i> Voltar
          </a>
        </div>
      </div>
    </div>
