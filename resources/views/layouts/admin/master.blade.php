...
<nav class="navbar navbar-vertical fixed-left navbar-expand-md navbar-light bg-white" id="sidenav-main">
    <div class="container-fluid">
        ...
        <a class="navbar-brand pt-0" href="#">
            <img src="{{asset('vendor/argon/assets/img/brand/logo.png')}}" class="navbar-brand-img" alt="cardappion">
        </a>
        <!-- User -->
            ...
            <div class="navbar-collapse-header d-md-none">
                <div class="row">
                    <div class="col-6 collapse-brand">
                        <a href="{{asset('vendor/argon/assets/img/brand/logo.png')}}">
                        <img src="" class="navbar-brand-img" alt="cardappion">
                        </a>
                    </div>
...
<nav class="navbar navbar-top navbar-expand-md navbar-dark bg-dark " id="navbar-main">
        <div class="container-fluid">
            ...
            <a class="h4 mb-0 text-white d-none d-lg-inline-block" href="{{ Auth::user()->tenant->url_token }}">
            <i class="ni ni-world-2 "></i> <b class="font-weight-bold 900"> 
            {{ Auth::user()->tenant->url_token }} </b>
            </a>
            <!-- Form -->
