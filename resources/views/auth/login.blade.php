...
<body class="bg-default">
        ...
        <ul class="navbar-nav align-items-lg-center ml-lg-auto">
          ...
          <li class="nav-item d-none d-lg-block ml-lg-4">
            <a href="{{ route('register')}}" target="_blank" class="btn btn-neutral btn-icon">
              ...
              <span class="nav-link-inner--text">Não tem uma conta? Cadastre-se</span>
            </a>
          </li>
        </ul>
      </div>
  ...
  <div class="main-content">
    <!-- Header -->
    <div class="header bg-gradient-success py-4 py-lg-8 pt-lg-2">
      <div class="container">
        ...
        <div class="col-lg-5 col-md-7">
              ...
              <form role="form" action="{{ route('login') }}" method="POST">
                ...
                <div class="custom-control custom-control-alternative custom-checkbox">
                  ...
                  <label class="custom-control-label" for=" customCheckLogin">
                    <span class="text-muted">Me lembre</span>
                  </label>
                </div>
          ...
          <div class="row mt-3">
            ...
            <div class="col-6 text-right">
              <a href="#" class="text-light"><small>Criar uma conta</small></a>
            </div>
          </div>
        </div>
      </div> 
      ...
      <div class="row align-items-center justify-content-xl-between">
        <div class="col-xl-6">
          <div class="copyright text-center text-xl-left text-muted">
            &copy; 2019 <a href="https://www.pontodecoleta.com.br" class="font-weight-bold ml-1" target="_blank">Ponto de Coleta</a>
          </div>
        </div>
        <div class="col-xl-6">
